...
public class RuValidator implements ConstraintValidator<Ru, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        try {
            Pattern p = Pattern.compile("(^(https?:\\/\\/)?[\\w\\-.]+\\.(sogou\\.com|sohu\\.com|qq\\.com|soso\\.com|go2map\\.com|pinyin\\.cn|teemo\\.cn)($|\\?|\\/|\\\\|:[\\d]))|(^(https?:\\/\\/)?+(2288wxy\\.com\\.cn|8888you\\.cn|pr.vaf.cn\\.cn)($|\\?|\\/|\\\\|:[\\d]))", Pattern.CASE_INSENSITIVE);
