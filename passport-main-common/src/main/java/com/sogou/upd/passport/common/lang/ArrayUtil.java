...
public class ArrayUtil {
    ...
    public static List toList(Object array, List list) {
        ...
        if (!array.getClass().isArray()) {
            ...
            if (list == null) {
                list = Lists.newArrayList(longArray.length);
            }
            ...
            if (list == null) {
                list = Lists.newArrayList(intArray.length);
            }
            ...
            if (list == null) {
                list = Lists.newArrayList(shortArray.length);
            }
            ...
            if (list == null) {
                list = Lists.newArrayList(byteArray.length);
            }
            ...
            if (list == null) {
                list = Lists.newArrayList(doubleArray.length);
            }
            ...
            if (list == null) {
                list = Lists.newArrayList(floatArray.length);
            }
            ...
            if (list == null) {
                list = Lists.newArrayList(booleanArray.length);
            }
            ...
            if (list == null) {
                list = Lists.newArrayList(charArray.length);
            }
            ...
            if (list == null) {
                list = Lists.newArrayList(objectArray.length);
            }
