...
public class KvUtils {
    ...
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_setObject", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_getObject", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_delete", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
     ...
     * @param value
     */
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_pushStringToSet", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
     ...
     */
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_pushStringToList", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_pushObjectToList", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
     ...
     * 获取list中的第一个成员
     */
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_getFirstStringFromList", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
    ...
    // 查询键key的列表
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_getList<String>", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
    public LinkedList<String> getList(String key) {
        return getObject(key, LinkedList.class);
    }

    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_getList<Object>", timeThreshold = 25, normalAndSlowSuffixesEnabled = true)
