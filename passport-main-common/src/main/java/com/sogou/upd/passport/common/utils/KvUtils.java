...
//    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_set")
    ...
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_setObject", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
...
//    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_get")
    ...
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_getObject", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_delete", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
     ...
     * @param value
     */
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_pushStringToSet", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
     ...
     */
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_pushStringToList", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_pushObjectToList", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
     ...
     * 获取list中的第一个成员
     */
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_getFirstStringFromList", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
    ...
    // 查询键key的列表
    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_getList<String>", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
    public LinkedList<String> getList(String key) {
        return getObject(key, LinkedList.class);
    }

    @Profiled(el = true, logger = KV_PERF4J_LOGGER, tag = "kv_getList<Object>", timeThreshold = 0, normalAndSlowSuffixesEnabled = true)
