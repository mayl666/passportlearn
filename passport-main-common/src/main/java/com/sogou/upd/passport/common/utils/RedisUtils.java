    ...
    */
    public void set(String key, Object obj,long timeout,TimeUnit timeUnit) throws Exception {
        try {
            ...
            setRightCount++;
            logger.info("redis Set正确!num="+setRightCount);
        } catch (Exception e) {
            setWrongCount++;
            logger.info("redis Set错误!num="+setWrongCount);
            logger.error("[Cache] set cache fail, key:" + key + " value:" + obj, e);
    ...
    */
    public <T> void multiSet(Map<String, T> mapData) throws Exception {
        try {
            ...
            multiSetRightCount++;
            logger.info("multiset 正确：num="+multiSetRightCount);
        } catch (Exception e) {
            multiSetWrongCount++;
            logger.info("multiset 错误：num="+multiSetWrongCount);
   ...
   */
    public String get(String key) {
        try {
            ...
            getRightCount ++;
            logger.info("get 正确:num="+getRightCount);
            return    res;
        } catch (Exception e) {
            getWrongCount ++;
            logger.info("get 错误:num="+getWrongCount);
    ...
    */
    public List<String> multiGet(List<String> keyList) {
        try {
            ...
            multiGetRightCount++;
            logger.info("multiget 正确：num="+multiGetRightCount);
            return res;
        } catch (Exception e) {
            multiGetRightCount++;
            logger.info("multiget 错误：num="+multiGetRightCount);
