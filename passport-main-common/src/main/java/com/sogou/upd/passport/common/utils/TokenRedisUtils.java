...
public class TokenRedisUtils {
    ...
    * 设置缓存内容
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_setObject", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
     ...
     * TODO:是否抛出异常及如何处理
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_setEx", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    public void setWithinSeconds(String key, String value, long timeout) throws Exception {
        set(key, value, timeout, TimeUnit.SECONDS);
    }

    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_setObjectEx", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
     ...
     * 设置缓存内容
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_multiSet", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    /*
      * 设置缓存内容
      */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_increment", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    * 冲突不覆盖
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_setNx", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
   ...
   * 根据key取缓存内容
   */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_get", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
     ...
     * 根据key取缓存内容
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_multiGet", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
     ...
     * 根据key取对象
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_getObject", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
   ...
   * 判断key是否存在
   */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_checkKeyIsExist", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
   ...
   * 获取hash中所有的映射关系
   */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hGetAll", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    * 设置hash映射关系
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hPutAll", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    * 设置hash映射关系
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hPutAllObject", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
     ...
     * 记录存在则覆盖，不存在则插入
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hPut", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hPutObject", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
     ...
     * 获取hash值
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hGet", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hGetObject", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
     ...
     * 删除Hash键值
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hDelete", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_hIncrBy", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_expire", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_delete", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    public void delete(String cacheKey) {
        redisTemplate.delete(cacheKey);
    }

    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_multiDelete", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
   ...
   */
     ...
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_addStringToSet", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
     ...
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_membersSet", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_RightPushStringToList", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_LeftPushStringToList", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_LeftPushObjectToList", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    // 查询键key的列表
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_getList", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "tokenRedies_getListByClass", timeThreshold = 1, normalAndSlowSuffixesEnabled = true)
