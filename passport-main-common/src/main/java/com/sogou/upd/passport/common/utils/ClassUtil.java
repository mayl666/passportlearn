...
/**
 * 有关 <code>Class</code> 处理的工具类。 <p/> <p> 这个类中的每个方法都可以“安全”地处理 <code>null</code> ，而不会抛出
 * <code>NullPointerException</code>。 </p>
 *
 * @author shipengzhi
 * @version 13-5-14 下午2:25
 */
public class ClassUtil {
  ...
  /**
   * 取得对象所属的类的直观类名。 <p/> <p> 相当于 <code>object.getClass().getName()</code> ，但不同的是，该方法用更直观的方式显示数组类型。
   * 例如：
   * <pre>
   ...
   * </p>
   *
   * <p> 对于非数组的类型，该方法等效于 <code>Class.getName()</code> 方法。 </p>
   *
   * <p> 注意，该方法所返回的数组类名只能用于显示给人看，不能用于 <code>Class.forName</code> 操作。 </p>
   *
  ...
  /**
   * 取得直观的类名。 <p/> <p> 相当于 <code>clazz.getName()</code> ，但不同的是，该方法用更直观的方式显示数组类型。 例如：
   * <pre>
   *  int[].class.getName() = "[I" ClassUtil.getClassName(int[].class) = "int[]"
   *
   *  Integer[][].class.getName() = "[[Ljava.lang.Integer;" ClassUtil.getClassName(Integer[][].class)
  ...
  /**
   * 取得直观的类名。 <p/> <p> <code>className</code> 必须是从 <code>clazz.getName()</code>
  ...
  /**
   * 取得指定对象所属的类的短类名，不包括package名。 <p/> <p> 此方法可以正确显示数组和内联类的名称。 </p> <p/> <p> 例如：
   * <pre>
  ...
  /**
   * 取得短类名，不包括package名。 <p/> <p> 此方法可以正确显示数组和内联类的名称。 </p> <p/> <p> 例如：
   * <pre>
   *  ClassUtil.getShortClassName(Boolean.class) = "Boolean" ClassUtil.getShortClassName(Boolean[].class)
   * = "Boolean[]" ClassUtil.getShortClassName(int[][].class) = "int[][]"
   * ClassUtil.getShortClassName(Map.Entry.class) = "Map.Entry"
   *  </pre>
   * </p>
   *
   * @param clazz 要查看的类
  ...
  /**
   * 取得类名，不包括package名。 <p/> <p> 此方法可以正确显示数组和内联类的名称。 </p> <p/> <p> 例如：
   * <pre>
   *  ClassUtil.getShortClassName(Boolean.class.getName()) = "Boolean"
   * ClassUtil.getShortClassName(Boolean[].class.getName()) = "Boolean[]"
   * ClassUtil.getShortClassName(int[][].class.getName()) = "int[][]"
  ...
  /**
   * 取得指定对象所属的类的package名。 <p/> <p> 对于数组，此方法返回的是数组元素类型的package名。 </p>
   *
   * @param object 要查看的对象
  ...
  /**
   * 取得指定类的package名。 <p/> <p> 对于数组，此方法返回的是数组元素类型的package名。 </p>
   *
   * @param clazz 要查看的类
  ...
  /**
   * 取得指定类名的package名。 <p/> <p> 对于数组，此方法返回的是数组元素类型的package名。 </p>
   *
   * @param className 要查看的类名
  ...
  /**
   * 取得指定对象所属的类的package名的资源名。 <p/> <p> 对于数组，此方法返回的是数组元素类型的package名。 </p>
   *
   * @param object 要查看的对象
   * @return package名，如果对象为 <code>null</code> ，则返回 <code>null</code>
   */
  ...
  /**
   * 取得指定类的package名的资源名。 <p/> <p> 对于数组，此方法返回的是数组元素类型的package名。 </p>
   *
   * @param clazz 要查看的类
   * @return package名，如果类为 <code>null</code> ，则返回 <code>null</code>
   */
  ...
  /**
   * 取得指定类名的package名的资源名。 <p/> <p> 对于数组，此方法返回的是数组元素类型的package名。 </p>
   *
   * @param className 要查看的类名
   * @return package名，如果类名为空，则返回 <code>null</code>
   */
  ...
  /**
   * 取得指定类的所有父类。 <p/> <p> 对于一个 <code>Class</code> 实例，如果它不是接口，也不是数组，此方法依次列出从该类的父类开始直到
   * <code>Object</code> 的所有类。 </p> <p/> <p> 例如 <code>ClassUtil.getSuperclasses(java.util.ArrayList.class)</code>
   * 返回以下列表： <p/> <ol> <li> <code>java.util.AbstractList</code> </li> <li>
   * <code>java.util.AbstractCollection</code> </li> <li> <code>java.lang.Object</code> </li>
   * </ol> </p> <p/> <p> 对于一个接口，此方法返回一个空列表。 </p> <p/> <p> 例如<code>ClassUtil.getSuperclasses(java.util.List.class)</code>将返回一个空列表。
   * </p> <p/> <p> 对于一个数组，此方法返回一个列表，列出所有component类型的父类的相同维数的数组类型。 例如：
   * <code>ClassUtil.getSuperclasses(java.util.ArrayList[][].class)</code> 返回以下列表： <p/> <ol> <li>
   * <code>java.util.AbstractList[][]</code> </li> <li> <code>java.util.AbstractCollection[][]</code>
   * </li> <li> <code>java.lang.Object[][]</code> </li> <li> <code>java.lang.Object[]</code> </li>
   * <li> <code>java.lang.Object</code> </li> </ol> <p/> 注意，原子类型及其数组，将被转换成相应的包装类来处理。 例如：
   * <code>ClassUtil.getSuperclasses(int[][].class)</code> 返回以下列表： <p/> <ol> <li>
   * <code>java.lang.Number[][]</code> </li> <li> <code>java.lang.Object[][]</code> </li> <li>
   * <code>java.lang.Object[]</code> </li> <li> <code>java.lang.Object</code> </li> </ol> </p>
   *
   * @param clazz 要查找的类
  ...
  /**
   * 取得指定类的所有接口。 <p/> <p> 对于一个 <code>Class</code> 实例，如果它不是接口，也不是数组，此方法依次列出从该类的父类开始直到
   * <code>Object</code> 的所有类。 </p> <p/> <p> 例如 <code>ClassUtil.getInterfaces(java.util.ArrayList.class)</code>
   * 返回以下列表： <p/> <ol> <li> <code>java.util.List</code> </li> <li> <code>java.util.Collection</code>
   * </li> <li> <code>java.util.RandomAccess</code> </li> <li> <code>java.lang.Cloneable</code>
   * </li> <li> <code>java.io.Serializable</code> </li> </ol> </p> <p/> <p>
   * 对于一个数组，此方法返回一个列表，列出所有component类型的接口的相同维数的数组类型。 例如： <code>ClassUtil.getInterfaces(java.util.ArrayList[][].class)</code>
   * 返回以下列表： <p/> <ol> <li> <code>java.util.List[][]</code> </li> <li>
   * <code>java.util.Collection[][]</code> </li> <li> <code>java.util.RandomAccess[][]</code>
   * </li> <li> <code>java.lang.Cloneable[][]</code> </li> <li> <code>java.io.Serializable[][]</code>
   * </li> </ol> </p> <p/> <p> 注意，原子类型及其数组，将被转换成相应的包装类来处理。 例如： <code>ClassUtil.getInterfaces(int[][].class)</code>
   * 返回以下列表： <p/> <ol> <li> <code>java.lang.Comparable[][]</code> </li> <li>
   * <code>java.io.Serializable[][]</code> </li> </ol> </p>
   *
   * @param clazz 要查找的类
  ...
  /**
   * 检查指定类型 <code>fromClass</code> 的对象是否可以赋值给另一种类型 <code>clazz</code>。 <p/> <p> 此方法可以用来确定指定类型的参数
   * <code>object1, object2, ...</code> 是否可以用来调用确定参数类型 <code>class1, class2, ...</code> 的方法。 </p>
   * <p/> <p> 按照如下规则： <p/> <ol> <li> 如果目标类 <code>clazz</code> 为 <code>null</code> ，总是返回
   * <code>false</code>。 </li> <li> 如果参数类型 <code>fromClass</code> 为 <code>null</code> ，并且目标类型
   * <code>clazz</code> 为非原子类型，则返回 <code>true</code>。 因为 <code>null</code> 可以被赋给任何引用类型。 </li> <li>
   * 调用 <code>Class.isAssignableFrom</code> 方法来确定目标类 <code>clazz</code> 是否和参数类
   * <code>fromClass</code> 相同或是其父类、接口，如果是，则返回 <code>true</code>。 </li> <li> 如果目标类型
   * <code>clazz</code> 为原子类型，那么根据 <a href="http://java.sun.com/docs/books/jls/">The Java Language
   * Specification</a> ，sections 5.1.1, 5.1.2, 5.1.4定义的Widening Primitive Conversion规则，参数类型
   * <code>fromClass</code> 可以是任何能扩展成该目标类型的原子类型及其包装类。 例如， <code>clazz</code> 为 <code>long</code>
   * ，那么参数类型可以是 <code>byte</code>、 <code>short</code>、<code>int</code>、<code>long</code>、<code>char</code>
   * 及其包装类 <code>java.lang.Byte</code>、<code>java.lang.Short</code>、<code>java.lang.Integer</code>、
   * <code>java.lang.Long</code> 和 <code>java.lang.Character</code> 。如果满足这个条件，则返回
   * <code>true</code>。 </li> <li> 不满足上述所有条件，则返回 <code>false</code>。 </li> </ol> </p>
   *
  ...
  protected static class TypeInfo {
    ...
    private List superclasses = Lists.newArrayList(2);
    private List interfaces = Lists.newArrayList(2);
