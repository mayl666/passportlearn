...
public class CommonConstant {
    ...
    //双写异常原因
    public static final String SGSUCCESS_SHERROR = "write_SGSuccess_SHError";//SG写失败，SH写失败 \
    public static final String SGSUCCESS_SHUNBINDERROR = "write_SGSuccess_SHUnBindError";//SG写失败，SH解除绑定失败
