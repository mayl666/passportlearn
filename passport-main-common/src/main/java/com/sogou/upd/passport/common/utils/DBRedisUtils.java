...
public class DBRedisUtils {
    ...
    private static Logger logger = LoggerFactory.getLogger(DBRedisUtils.class);
    private static final Logger redisMissLogger = LoggerFactory.getLogger("dBRedisMissLogger");
    ...
    * 设置缓存内容
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_set", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    * 设置缓存内容
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_setObject", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
     ...
     * TODO:是否抛出异常及如何处理
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_setEx", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    public void setWithinSeconds(String key, String value, long timeout) throws Exception {
        set(key, value, timeout, TimeUnit.SECONDS);
    }

    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_setObjectEx", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
     ...
     * 设置缓存内容
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_multiSet", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    /*
      * 设置缓存内容
      */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_increment", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    * 冲突不覆盖
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_setNx", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
   ...
   * 根据key取缓存内容
   */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_get", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
     ...
     * 根据key取缓存内容
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_multiGet", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
     ...
     * 根据key取对象
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_getObject", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
   ...
   * 判断key是否存在
   */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_checkKeyIsExist", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
   ...
   * 获取hash中所有的映射关系
   */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hGetAll", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    * 设置hash映射关系
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hPutAll", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    * 设置hash映射关系
    */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hPutAllObject", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
     ...
     * 记录存在则覆盖，不存在则插入
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hPut", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hPutObject", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
     ...
     * 获取hash值
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hGet", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hGetObject", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
     ...
     * 删除Hash键值
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hDelete", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_hIncrBy", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_expire", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_delete", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    public void delete(String cacheKey) {
        redisTemplate.delete(cacheKey);
    }

    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_multiDelete", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
   ...
   */
     ...
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_addStringToSet", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
     ...
     */
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_membersSet", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_RightPushStringToList", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_LeftPushStringToList", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_LeftPushObjectToList", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    // 查询键key的列表
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_getList", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
    ...
    @Profiled(el = true, logger = "rediesTimingLogger", tag = "dBRedies_getListByClass", timeThreshold = 10, normalAndSlowSuffixesEnabled = true)
