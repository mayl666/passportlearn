...
//    public static final String INVALID_ACCESS_TOKEN = "108";
    ...
    // 登陆用户存在风险，请修改密码
    public static final String ERR_CODE_ACCOUNT_LEAKLIST_RISK = "20500";
    // 登陆账号未激活
    ...
    // 密码为6-16位，不允许纯数字或纯字母
    public static final String ERR_CODE_PASSWORD_STRENGTH_WEAK = "20268";
    ...
    static {
        ...
        ERR_CODE_MSG_MAP.put(ERR_CODE_PASSWORD_STRENGTH_WEAK, "密码为6-16位，不允许纯数字或纯字母");
        ...
        ERR_CODE_MSG_MAP.put(ERR_CODE_ACCOUNT_PHONE_NOBIND, "该手机号未注册，推荐短信验证登录");
