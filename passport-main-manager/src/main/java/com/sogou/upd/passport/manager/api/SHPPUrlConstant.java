...
public class SHPPUrlConstant {
    ...
    public static final String HTTPS_SET_COOKIE = BASE_URL + "sso/setcookie.jsp";//用于前端设置cookie
    public static final String HTTP_SET_COOKIE = "http://passport.sohu.com/sso/setcookie.jsp";//用于前端设置cookie
