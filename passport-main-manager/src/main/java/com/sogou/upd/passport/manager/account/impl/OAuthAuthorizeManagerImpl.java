 ...
 */
@Component
public class OAuthAuthorizeManagerImpl implements OAuthAuthorizeManager {

    private static final Logger logger = LoggerFactory.getLogger(OAuthAuthorizeManagerImpl.class);
