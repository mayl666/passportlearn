...
//            Assert.assertTrue(expire_sogou_ResultForm.equals(sogou_APIResultForm));
    ...
    public void testAuthUser_Success() {
        try {
            ...
            Result result_email = loginManager.authUser(username_waiyu, ip, pwdMD5_email, false, false);
            APIResultForm email_APIResultForm = JacksonJsonMapperUtil.getMapper().readValue(result_email.toString(), APIResultForm.class);
            String expire_email_data = "{\"data\":{\"userid\":\"" + username_waiyu + "\"},\"status\":\"0\",\"statusText\":\"登录成功\"}";
            ...
            Result result_phone = loginManager.authUser(username_phone, ip, pwdMD5_phone, false, false);
            ...
            Result result_phone_pp = loginManager.authUser(passportId_phone, ip, pwdMD5_phone_pp, false, false);
            ...
            Result result_sogou = loginManager.authUser(username_sogou, ip, pwdMD5_sogou, false, false);
            APIResultForm sogou_APIResultForm = JacksonJsonMapperUtil.getMapper().readValue(result_sogou.toString(), APIResultForm.class);
            ...
            Result result_gexing = loginManager.authUser("tinkame732", ip, pwdMD5_gexing, false, false);
            ...
            Result result_bind_mobile = loginManager.authUser(mobile_1, ip, pwdMD5_bind_mobile, false, false);
