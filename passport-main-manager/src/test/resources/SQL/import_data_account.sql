...
insert into `account_00` (`id`, `passport_id`, `password`, `mobile`, `reg_time`, `reg_ip`, `flag`, `passwordtype`, `account_type`, `uniqname`, `avatar`) values('2','tinkame732@sogou.com','y16GEmXI$zCNDRNEjMDVCmsQ.zDaJa.',NULL,'2014-04-22 17:32:48','10.129.192.193','1','2','1',NULL,NULL);
