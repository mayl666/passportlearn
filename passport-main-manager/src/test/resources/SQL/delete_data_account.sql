...
DELETE FROM `account_18` WHERE passport_id = 'shipengzhi1986@sogou.com';
DELETE FROM `mobile_passportid_mapping_14` WHERE mobile = '13621009174';
DELETE FROM `uniqname_passportid_mapping_30` WHERE uniqname = '跳刀的兔子';

DELETE FROM `account_02` WHERE passport_id='18978941658@sohu.com';
DELETE FROM `mobile_passportid_mapping_28` WHERE mobile='18978941658';
