...
public class SinaAPIValidator extends AbstractClientValidator {
    ...
    static {
        ...
        SINA_OAUTH_ERROR_MAP.put("21315", ErrorUtil.CONNECT_TOKEN_INVALID);
        SINA_OAUTH_ERROR_MAP.put("21316", ErrorUtil.CONNECT_TOKEN_INVALID);
        SINA_OAUTH_ERROR_MAP.put("21317", ErrorUtil.CONNECT_TOKEN_INVALID);
        SINA_OAUTH_ERROR_MAP.put("21327", ErrorUtil.CONNECT_TOKEN_INVALID);
    }
