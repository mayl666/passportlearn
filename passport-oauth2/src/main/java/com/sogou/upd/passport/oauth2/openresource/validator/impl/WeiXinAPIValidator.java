...
public class WeiXinAPIValidator extends AbstractClientValidator {
    ...
    static {
        ...
        WEIXIN_OAUTH_ERROR_MAP.put("40003", ErrorUtil.ERR_CODE_CONNECT_INVALID_OPENID);
        ...
        WEIXIN_OAUTH_ERROR_MAP.put("42001", ErrorUtil.ACCESS_TOKEN_EXPIRED);
        ...
        WEIXIN_OAUTH_ERROR_MAP.put("45011", ErrorUtil.ERR_CODE_CONNECT_REQUEST_FREQUENCY_LIMIT);
        WEIXIN_OAUTH_ERROR_MAP.put("50001", ErrorUtil.ERR_CODE_CONNECT_REQUEST_NO_AUTHORITY);
    }
