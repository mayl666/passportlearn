    ...
    public String checkEmailResetPwd(HttpServletRequest request, WapCheckEmailParams params, Model model, RedirectAttributes redirectAttributes) throws Exception {
        ...
        try {
            ...
            if (!Strings.isNullOrEmpty(validateResult)) {
                ...
                return "redirect:/wap/findpwd/vm/reset?code={code}&message={message}";
            }
            String passportId = params.getUsername();
            int clientId = Integer.parseInt(params.getClient_id());
        ...
        if (result.isSuccess()) {
            ...
            return "redirect:/wap/findpwd/vm/reset?username={username}&scode={scode}&client_id={client_id}&ru={ru}&code={code}&message={message}&skin={skin}";
        }
        redirectAttributes.addAttribute("code", result.getCode());
        return "redirect:/wap/findpwd/vm/reset?username={username}&client_id={client_id}&ru={ru}&code={code}&message={message}&skin={skin}";
