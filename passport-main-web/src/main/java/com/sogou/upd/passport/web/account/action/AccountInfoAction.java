...
import com.sogou.upd.passport.manager.form.UploadAvatarParams;
...
public class AccountInfoAction extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = "/userinfo/checknickname")
    @ResponseBody
    public Object checkNickName(CheckNickNameParams params,HttpServletRequest request){
        ...
        result = accountInfoManager.checkNickName(params);
        return result.toString();
    }
