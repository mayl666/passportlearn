...
import com.sogou.upd.passport.common.lang.ClassLoaderUtil;
import com.sogou.upd.passport.result.excepiton.CreateEnumException;
 ...
 * @author shipengzhi
 */
public abstract class Enum extends Number implements Comparable, Serializable {
    ...
    private static Enum createEnum(String name, Number value, boolean withValue) {
        ...
        try {
            ...
            enumObject.setName(StringUtils.trimToNull(name));
...
//        boolean flagMode = enumObject instanceof Flags;
    ...
    public int compareTo(Object otherEnum) {
        if (!getClass().equals(otherEnum.getClass())) {
            throw new CreateEnumException(MessageFormat.format("Could not compare object of \"{0}\" with object of \"{1}\"",
                    new Object[]{
                            getClass().getName(),
