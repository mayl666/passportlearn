...
public abstract class AbstractResourceBundleFactory extends ResourceBundleFactory {
     ...
     * @throws com.sogou.upd.passport.result.excepiton.ResourceBundleCreateException
     *          指定bundle文件存在, 但创建bundle实例失败, 例如文件格式错误
     */
    ...
    public boolean equals(Object other) {
        ...
        try {
            ...
            return (loader == null) ? (otherFactory.loader == null)
