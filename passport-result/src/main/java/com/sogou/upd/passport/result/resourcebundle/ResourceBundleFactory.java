...
public abstract class ResourceBundleFactory {
    ...
    /**
     * 设置是否自动重新装载修改后的ResourceBundle，默认为false。
     * 如果设置为true，则每次获取ResourceBundle时检测相应的配置文件最后修改时间是否大于cache中缓存的修改时间，
     * 如果大于则清除相关缓存，重新加载相关配置并保存在cache中。
     * 在对性能要求较高的情况下，建议使用 <code>ResourceBundleFactory.clearCache()</code> 手工管理cache。
     *
     * @param autoReload
     */
    ...
    private static final class Helper {
        ...
        private static Object findBundle(ResourceBundleFactory factory, String bundleName,
                                         Locale defaultLocale, String baseName, Object parent, final Object NOT_FOUND)
                throws ResourceBundleCreateException {
    ...
    private static final class Cache extends SoftHashMap {
         ...
         */
        public synchronized Object remove(ResourceBundleFactory factory, String bundleName,
                                          Locale defaultLocale) {
            cacheKey.set(factory, bundleName, defaultLocale);
         ...
         */
        public synchronized List removeAllValue(Object value) {
    ...
    private static final class CacheKey implements Cloneable {
        ...
        public String toString() {
            return new StringBuffer("CacheKey[factory=").append((factoryRef == null) ? "null"
                    : factoryRef
                    .get()).append(", bundleName=").append(bundleName).append(", defaultLocale=")
                    .append(defaultLocale).append("]").toString();
        }
    }
